...
CREATE TABLE `posts` (
  ...
  `excerpt` varchar(1000) CHARACTER SET utf8mb4 DEFAULT NULL,
  `content` text CHARACTER SET utf8mb4,
  `image_url` varchar(1024) CHARACTER SET utf8mb4 DEFAULT NULL,
  `like_count` int(10) unsigned NOT NULL DEFAULT '0',
  `favourite_count` int(10) unsigned NOT NULL DEFAULT '0',
  `comment_count` int(10) unsigned NOT NULL DEFAULT '0',
  `reputation` tinyint(3) unsigned NOT NULL DEFAULT '0',
  `md5_hash` varchar(32) CHARACTER SET utf8mb4 NOT NULL,
  `guid` text CHARACTER SET utf8mb4 NOT NULL,
  ...
  KEY `posts_like_count_published_at_index` (`like_count`,`published_at`),
  KEY `posts_favourite_count_published_at_index` (`favourite_count`,`published_at`),
  KEY `posts_comment_count_published_at_index` (`comment_count`,`published_at`),
  KEY `posts_reputation_published_at_index` (`reputation`,`published_at`),
